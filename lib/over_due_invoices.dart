...
class over_due_invoices extends StatefulWidget{
  _over_due_invoices createState() => _over_due_invoices();
}
class _over_due_invoices extends State<over_due_invoices>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Overdue invoices", style: TextStyle(color: Colors.black),),
