...
class trial_balance extends StatefulWidget{
  _trial_balance createState() => _trial_balance();
}
class _trial_balance extends State<trial_balance>{
  late Future str;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Trial balance", style: TextStyle(color: Colors.black),),
