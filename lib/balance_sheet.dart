...
class balance_sheet extends StatefulWidget{
  _balance_sheet createState() => _balance_sheet();
}
class _balance_sheet extends State<balance_sheet>{
  late Future str;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Balance sheet", style: TextStyle(color: Colors.black),),
